class SimpleMotion(object):
    ...
    def __init__(self, robot, linear_vel, angular_vel, exit_condition):
        self._robot = robot
    ...
    def _risk_of_collision(self):
        return min([self._robot.free_space_ahead, self._robot.free_space_left, self._robot.free_space_right]) < self._robot.SENSORS_RANGE
