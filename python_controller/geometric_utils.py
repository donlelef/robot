...
class Position2D:
    ...
    def is_close_to(self, other, tolerance):
        return self.get_distance_from(other) < tolerance
...
def main():
    ...
    print(str(line1))
    print(str(line1.contains_point(Position2D(2, 2), 0.1)))
    print(str(line1.contains_point(Position2D(2, 3), 0.1)))

    line2 = Line2D.from_two_points(Position2D(2, 3), Position2D(2, 6))
    print(str(line2))
    print(str(line2.contains_point(Position2D(2, 8), 0.1)))
    print(str(line2.contains_point(Position2D(1, 2), 0.1)))
